...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Machine.end_time_estimated'
        db.delete_column(u'core_machine', 'end_time_estimated')


    def backwards(self, orm):
        # Adding field 'Machine.end_time_estimated'
        db.add_column(u'core_machine', 'end_time_estimated',
