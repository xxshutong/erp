...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Machine.no'
        # db.alter_column(u'core_machine', 'no', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        pass

        # Changing field 'Machine.no'
        # db.alter_column(u'core_machine', 'no', self.gf('django.db.models.fields.CharField')(max_length=20))
