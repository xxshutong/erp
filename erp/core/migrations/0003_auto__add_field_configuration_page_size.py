...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.page_size'
        db.add_column(u'core_configuration', 'page_size',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.page_size'
        db.delete_column(u'core_configuration', 'page_size')
