...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.output_estimated'
        db.add_column(u'core_machine', 'output_estimated',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.output_estimated'
        db.delete_column(u'core_machine', 'output_estimated')
    ...
    models = {
        ...
        u'core.machine': {
            ...
            'output_estimated': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
